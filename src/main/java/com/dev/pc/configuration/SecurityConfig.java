...
//                    .antMatchers(HttpMethod.GET,"/api/v1/**").permitAll()
                    ...
                    .antMatchers(HttpMethod.GET,"/api/v1/costos/**").permitAll()
                    .antMatchers(HttpMethod.GET,"/api/v1/costo-otros/**").permitAll()
...
//                    .antMatchers(HttpMethod.PUT,"/api/v1/deudas/service").permitAll()
                    ...
                    .antMatchers(HttpMethod.GET,"/api/v1/pagos-deta/**").permitAll()
                    ...
                    .antMatchers(HttpMethod.GET,"/api/v1/voucher-detalles/**").permitAll()
